        ...
        <div class="bg-white rounded shadow-lg p-6">
            <form method="post" action="{{ route('profile.destroy') }}">
                ...
                <div class="mt-6 flex justify-end">
                    <button @click="open = false" type="button" class="bg-gray-300 text-gray-800 px-4 py-2 rounded">
                        {{ __('Cancel') }}
                    </button>
                    <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded ms-3">
                        {{ __('Delete Account') }}
                    </button>
                </div>
            </form>
